        ...
        <div className="flex items-center gap-4">
          ...
          >
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="tabler-icon tabler-icon-moon w-5 h-5 text-blue-600 dark:text-blue-400"
            >
              <path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z"></path>
            </svg>
          </button>
          <div>
            <img src="/src/assets/default-user.png" alt="" className="w-5 border border-blue-500 rounded-full"/>
        </div>
        </div>
